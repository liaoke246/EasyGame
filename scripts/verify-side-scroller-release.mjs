...
const sourceFolders = ['Assets/Game/Scripts', 'Assets/Game/Editor', 'Assets/WebGLTemplates/SideScroller', 'Assets/Plugins/WebGL', 'Assets/Game/Resources/Effects'];
...
export async function sourceFingerprint(root) {
  ...
  for (const folder of sourceFolders)
    inputs.push(...(await filesUnder(root, folder)).filter(file => /\.(cs|html|js|jslib|shader)$/.test(file)));
  let listing = '';
